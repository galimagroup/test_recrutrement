...
public class APIExceptionHandler {
    ...
    public ResponseEntity<APIException> handleRequestException(RequestException e) {
        APIException exception = new APIException(
                e.getMessage(),
                e.getStatus(), // Utilisez le status de l'exception
                LocalDateTime.now()
        );
    ...
    public ResponseEntity<APIException> handleMethodArgumentNotValidExceptionException(MethodArgumentNotValidException e){
